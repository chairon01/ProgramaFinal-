		...
		<div className="container">
			...
			<div className="container-1">
				<div className="cell-1">
					<img src="https://i.picsum.photos/id/1012/600/600.jpg" className="rounded-circle" alt="..." />
				</div>
				<div className="cell-2 d-flex align-items-center">
			...
			<div className="container-2">
				...
				<div className="cell-4 d-flex align-items-center">
					<img src="https://i.picsum.photos/id/1011/600/600.jpg" className="rounded-circle" alt="..." />
				</div>
			</div>
			<div className="container-1">
				<div className="cell-1">
					<img src="https://i.picsum.photos/id/1020/600/600.jpg" className="rounded-circle" alt="..." />
				</div>
				<div className="cell-2 d-flex align-items-center">
					<p className="card-text-1">
						<h1>Delivery</h1>
